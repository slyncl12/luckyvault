...
function App() {
  ...
  const DRAW_CONFIG_ID = '0xd327dfe9539cb3cf87d5672cfc2e87eba05f79da4c6cd0af4885ecf363bb1a97'
  const JACKPOT_TIERS_ID = '0xad2f4784050cd60cd1cdfdb7f6152aa9ff2e0827ffdb4f22c26d218e4fb34c3f'
  const SUILEND_TRACKER_ID = '0x1bb851ebc6dbf1eb357733a027bea1a2f8fdae56d2dad16ff9740fa59c101fad'  
...
const handleDeposit = async () => {
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      tx.moveCall({
        target: `${PACKAGE_ID}::lottery_personal::withdraw_smart`,
        typeArguments: [USDC_TYPE],
        arguments: [
          tx.object(POOL_ID),
          tx.object(SUILEND_TRACKER_ID),
